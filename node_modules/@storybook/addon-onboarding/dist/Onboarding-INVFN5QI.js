...
import { ArrowRightIcon, CloseAltIcon } from '@storybook/icons';
...
Valid keys: `+JSON.stringify(Object.keys(shapeTypes),null,"  "));var error=checker(propValue,key,componentName,location,propFullName+"."+key,ReactPropTypesSecret);if(error)return error}return null}return createChainableTypeChecker(validate)}function isNode(propValue){switch(typeof propValue){case"number":case"string":case"undefined":return !0;case"boolean":return !propValue;case"object":if(Array.isArray(propValue))return propValue.every(isNode);if(propValue===null||isValidElement2(propValue))return !0;var iteratorFn=getIteratorFn(propValue);if(iteratorFn){var iterator=iteratorFn.call(propValue),step;if(iteratorFn!==propValue.entries){for(;!(step=iterator.next()).done;)if(!isNode(step.value))return !1}else for(;!(step=iterator.next()).done;){var entry=step.value;if(entry&&!isNode(entry[1]))return !1}}else return !1;return !0;default:return !1}}function isSymbol(propType,propValue){return propType==="symbol"?!0:propValue?propValue["@@toStringTag"]==="Symbol"||typeof Symbol=="function"&&propValue instanceof Symbol:!1}function getPropType(propValue){var propType=typeof propValue;return Array.isArray(propValue)?"array":propValue instanceof RegExp?"object":isSymbol(propType,propValue)?"symbol":propType}function getPreciseType(propValue){if(typeof propValue>"u"||propValue===null)return ""+propValue;var propType=getPropType(propValue);if(propType==="object"){if(propValue instanceof Date)return "date";if(propValue instanceof RegExp)return "regexp"}return propType}function getPostfixForTypeWarning(value){var type=getPreciseType(value);switch(type){case"array":case"object":return "an "+type;case"boolean":case"date":case"regexp":return "a "+type;default:return type}}function getClassName(propValue){return !propValue.constructor||!propValue.constructor.name?ANONYMOUS:propValue.constructor.name}return ReactPropTypes.checkPropTypes=checkPropTypes,ReactPropTypes.resetWarningCache=checkPropTypes.resetWarningCache,ReactPropTypes.PropTypes=ReactPropTypes,ReactPropTypes};}});var require_prop_types=__commonJS({"../../node_modules/prop-types/index.js"(exports,module){ReactIs=require_react_is(),throwOnDirectAccess=!0,module.exports=require_factoryWithTypeCheckers()(ReactIs.isElement,throwOnDirectAccess);var ReactIs,throwOnDirectAccess;}});var require_react_innertext=__commonJS({"../../node_modules/react-innertext/index.js"(exports,module){var hasProps=function(jsx){return Object.prototype.hasOwnProperty.call(jsx,"props")},reduceJsxToString=function(previous,current){return previous+innerText2(current)},innerText2=function(jsx){return jsx===null||typeof jsx=="boolean"||typeof jsx>"u"?"":typeof jsx=="number"?jsx.toString():typeof jsx=="string"?jsx:Array.isArray(jsx)?jsx.reduce(reduceJsxToString,""):hasProps(jsx)&&Object.prototype.hasOwnProperty.call(jsx.props,"children")?innerText2(jsx.props.children):""};innerText2.default=innerText2;module.exports=innerText2;}});var e='@keyframes Bc2PgW_ya{to{translate:0 var(--sh)}}@keyframes Bc2PgW_xa{to{translate:var(--xlp)0}}@keyframes Bc2PgW_r{50%{rotate:var(--hr)180deg}to{rotate:var(--r)360deg}}.Bc2PgW_c{z-index:1200;width:0;height:0;position:relative;overflow:visible}.Bc2PgW_p{animation:xa var(--dc)forwards cubic-bezier(var(--x1),var(--x2),var(--x3),var(--x4));animation-name:Bc2PgW_xa}.Bc2PgW_p>div{animation:ya var(--dc)forwards cubic-bezier(var(--y1),var(--y2),var(--y3),var(--y4));width:var(--w);height:var(--h);animation-name:Bc2PgW_ya;position:absolute;top:0;left:0}.Bc2PgW_p>div:before{content:"";background-color:var(--bgc);animation:r var(--rd)infinite linear;border-radius:var(--br);width:100%;height:100%;animation-name:Bc2PgW_r;display:block}',t="Bc2PgW_p",r="Bc2PgW_c",a=["#FFC700","#FF0000","#2E3191","#41BBC7"],o=3500,n=.5,i=150,c="mix",s=12,l="",d=!0,p=800,u=1600;function y(y2,z2={}){let{colors:A2=a,duration:H2=o,force:F2=n,particleCount:O=i,particleShape:j=c,particleSize:E=s,particleClass:$=l,destroyAfterDone:q=d,stageHeight:D=p,stageWidth:J=u}=z2;((function(e2){if(document.querySelector("style[data-neoconfetti]"))return;let t2=W("style");t2.dataset.neoconfetti="",t2.textContent=e2,_(document.head,t2);}))(e),y2.classList.add(r),y2.style.setProperty("--sh",D+"px");let I=[],G=[],K=()=>P(b()*(N-1)),Q=(e2,t2)=>j!=="rectangles"&&(e2==="circles"||k(t2));function R(e2,t2){let r2=K(),a2=Q(j,r2),o2=(t3,r3)=>e2.style.setProperty(t3,r3+"");o2("--xlp",C(x(L(t2,90)-180),0,180,-J/2,J/2)+"px"),o2("--dc",H2-P(1e3*b())+"ms");let n2=b()<m?w(b()*h,2):0;o2("--x1",n2),o2("--x2",-1*n2),o2("--x3",n2),o2("--x4",w(x(C(x(L(t2,90)-180),0,180,-1,1)),4)),o2("--y1",w(b()*v,4)),o2("--y2",w(b()*F2*(M()?1:-1),4)),o2("--y3",v),o2("--y4",w(B(C(x(t2-180),0,180,F2,-F2),0),4)),o2("--w",(a2?E:P(4*b())+E/2)+"px"),o2("--h",(a2?E:P(2*b())+E)+"px");let i2=r2.toString(2).padStart(3,"0").split("");o2("--hr",i2.map(e3=>+e3/2+"").join(" ")),o2("--r",i2.join(" ")),o2("--rd",w(b()*(g-f)+f)+"ms"),o2("--br",a2?"50%":0);}let U;function V(){y2.innerHTML="",clearTimeout(U),I=S(O,A2),G=function(e2,r2=[],a2){let o2=[];for(let{color:n2}of r2){let r3=W("div");r3.className=`${t} ${a2}`,r3.style.setProperty("--bgc",n2);let i2=W("div");_(r3,i2),_(e2,r3),o2.push(r3);}return o2}(y2,I,$);for(let[e2,t2]of T(G))R(t2,I[+e2].degree);U=setTimeout(()=>{q&&(y2.innerHTML="");},H2);}return V(),{update(e2){let r2=e2.particleCount??i,f2=e2.particleShape??c,g2=e2.particleSize??s,m2=e2.particleClass??l,h2=e2.colors??a,v2=e2.stageHeight??p,x2=e2.duration??o,b2=e2.force??n,P2=e2.stageWidth??u,B2=e2.destroyAfterDone??d;I=S(r2,h2);let W2=!1;if(r2===O){G=Array.from(y2.querySelectorAll(`.${t}`));for(let[e3,{color:t2}]of T(I)){let r3=G[+e3];JSON.stringify(A2)!==JSON.stringify(h2)&&r3.style.setProperty("--bgc",t2),f2!==j&&r3.style.setProperty("--br",Q(f2,K())?"50%":"0"),m2!==$&&($&&r3.classList.remove($),m2&&r3.classList.add(m2));}}else W2=!0;q&&!B2&&clearTimeout(U),y2.style.setProperty("--sh",v2+"px"),H2=x2,A2=h2,F2=b2,O=r2,j=f2,E=g2,$=m2,q=B2,D=v2,J=P2,W2&&V();},destroy(){y2.innerHTML="",clearTimeout(U);}}}var f=200,g=800,m=.1,h=.3,v=.5,x=Math.abs,b=Math.random,P=Math.round,B=Math.max,W=e2=>document.createElement(e2),_=(e2,t2)=>e2.appendChild(t2),S=(e2,t2)=>Array.from({length:e2},(r2,a2)=>({color:t2[a2%t2.length],degree:360*a2/e2})),w=(e2,t2=2)=>P((e2+Number.EPSILON)*10**t2)/10**t2,C=(e2,t2,r2,a2,o2)=>(e2-t2)*(o2-a2)/(r2-t2)+a2,L=(e2,t2)=>e2+t2>360?e2+t2-360:e2+t2,M=()=>b()>.5,T=Object.entries,N=6,k=e2=>e2!==1&&M();function F({class:e2,...t2}){let r2=useRef(null),a2=useRef();return useEffect(()=>{if(typeof window<"u"&&r2.current){if(a2.current)return a2.current.update(t2),a2.current.destroy;a2.current=y(r2.current,t2);}},[t2]),createElement("div",{ref:r2,className:e2})}var Wrapper=styled.div({zIndex:9999,position:"fixed",top:0,left:"50%",width:"50%",height:"100%"}),Confetti=React2__default.memo(function({timeToFade=5e3,colors=["#CA90FF","#FC521F","#66BF3C","#FF4785","#FFAE00","#1EA7FD"],...confettiProps}){return React2__default.createElement(Wrapper,null,React2__default.createElement(F,{colors,particleCount:200,duration:5e3,stageHeight:window.innerHeight,stageWidth:window.innerWidth,destroyAfterDone:!0,...confettiProps}))});function HighlightElement({targetSelector,pulsating=!1}){return useEffect(()=>{let element=document.querySelector(targetSelector);if(element)if(pulsating){element.style.animation="pulsate 3s infinite",element.style.transformOrigin="center",element.style.animationTimingFunction="ease-in-out";let keyframes2=`
      ...
      `)),head.appendChild(style);}componentDidMount(){let{shouldFocus}=this.props;src_default.domElement(this.beacon)||console.warn("beacon is not a valid DOM element"),setTimeout(()=>{src_default.domElement(this.beacon)&&shouldFocus&&this.beacon.focus();},0);}componentWillUnmount(){let style=document.getElementById("joyride-beacon-animation");style?.parentNode&&style.parentNode.removeChild(style);}render(){let{beaconComponent,continuous,index,isLastStep,locale,onClickOrHover,size,step,styles}=this.props,title=src_default.string(locale.open)?locale.open:(0, import_react_innertext.default)(locale.open),sharedProps={"aria-label":title,onClick:onClickOrHover,onMouseEnter:onClickOrHover,ref:this.setBeaconRef,title},component;return beaconComponent?component=React2.createElement(beaconComponent,{continuous,index,isLastStep,size,step,...sharedProps}):component=React2.createElement("button",{key:"JoyrideBeacon",className:"react-joyride__beacon","data-test-id":"button-beacon",style:styles.beacon,type:"button",...sharedProps},React2.createElement("span",{style:styles.beaconInner}),React2.createElement("span",{style:styles.beaconOuter})),component}};function JoyrideTooltipCloseButton({styles,...props}){let{color:color2,height,width,...style}=styles;return React2__default.createElement("button",{style,type:"button",...props},React2__default.createElement("svg",{height:typeof height=="number"?`${height}px`:height,preserveAspectRatio:"xMidYMid",version:"1.1",viewBox:"0 0 18 18",width:typeof width=="number"?`${width}px`:width,xmlns:"http://www.w3.org/2000/svg"},React2__default.createElement("g",null,React2__default.createElement("path",{d:"M8.13911129,9.00268191 L0.171521827,17.0258467 C-0.0498027049,17.248715 -0.0498027049,17.6098394 0.171521827,17.8327545 C0.28204354,17.9443526 0.427188206,17.9998706 0.572051765,17.9998706 C0.71714958,17.9998706 0.862013139,17.9443526 0.972581703,17.8327545 L9.0000937,9.74924618 L17.0276057,17.8327545 C17.1384085,17.9443526 17.2832721,17.9998706 17.4281356,17.9998706 C17.5729992,17.9998706 17.718097,17.9443526 17.8286656,17.8327545 C18.0499901,17.6098862 18.0499901,17.2487618 17.8286656,17.0258467 L9.86135722,9.00268191 L17.8340066,0.973848225 C18.0553311,0.750979934 18.0553311,0.389855532 17.8340066,0.16694039 C17.6126821,-0.0556467968 17.254037,-0.0556467968 17.0329467,0.16694039 L9.00042166,8.25611765 L0.967006424,0.167268345 C0.745681892,-0.0553188426 0.387317931,-0.0553188426 0.165993399,0.167268345 C-0.0553311331,0.390136635 -0.0553311331,0.751261038 0.165993399,0.974176179 L8.13920499,9.00268191 L8.13911129,9.00268191 Z",fill:color2}))))}var CloseButton_default=JoyrideTooltipCloseButton;function JoyrideTooltipContainer(props){let{backProps,closeProps,continuous,index,isLastStep,primaryProps,size,skipProps,step,tooltipProps}=props,{content,hideBackButton,hideCloseButton,hideFooter,locale,showProgress,showSkipButton,styles,title}=step,{back,close,last,next,skip}=locale,output={primary:close};return continuous&&(output.primary=isLastStep?last:next,showProgress&&(output.primary=React2.createElement("span",null,output.primary," (",index+1,"/",size,")"))),output.primary&&(output.primary=React2.createElement("button",{"data-test-id":"button-primary",style:styles.buttonNext,type:"button",...primaryProps},output.primary)),showSkipButton&&!isLastStep&&(output.skip=React2.createElement("button",{"aria-live":"off","data-test-id":"button-skip",style:styles.buttonSkip,type:"button",...skipProps},skip)),!hideBackButton&&index>0&&(output.back=React2.createElement("button",{"data-test-id":"button-back",style:styles.buttonBack,type:"button",...backProps},back)),output.close=!hideCloseButton&&React2.createElement(CloseButton_default,{"data-test-id":"button-close",styles:styles.buttonClose,...closeProps}),React2.createElement("div",{key:"JoyrideTooltip","aria-label":getText(title)||getText(content),className:"react-joyride__tooltip",style:styles.tooltip,...tooltipProps},React2.createElement("div",{style:styles.tooltipContainer},title&&React2.createElement("h1",{"aria-label":getText(title),style:styles.tooltipTitle},title),React2.createElement("div",{style:styles.tooltipContent},content)),!hideFooter&&React2.createElement("div",{style:styles.tooltipFooter},React2.createElement("div",{style:styles.tooltipFooterSpacer},output.skip),output.back,output.primary),output.close)}var Container_default=JoyrideTooltipContainer,JoyrideTooltip=class extends React2.Component{constructor(){super(...arguments),__publicField(this,"handleClickBack",event=>{event.preventDefault();let{helpers}=this.props;helpers.prev();}),__publicField(this,"handleClickClose",event=>{event.preventDefault();let{helpers}=this.props;helpers.close("button_close");}),__publicField(this,"handleClickPrimary",event=>{event.preventDefault();let{continuous,helpers}=this.props;if(!continuous){helpers.close("button_primary");return}helpers.next();}),__publicField(this,"handleClickSkip",event=>{event.preventDefault();let{helpers}=this.props;helpers.skip();}),__publicField(this,"getElementsProps",()=>{let{continuous,isLastStep,setTooltipRef,step}=this.props,back=getText(step.locale.back),close=getText(step.locale.close),last=getText(step.locale.last),next=getText(step.locale.next),skip=getText(step.locale.skip),primaryText=continuous?next:close;return isLastStep&&(primaryText=last),{backProps:{"aria-label":back,"data-action":"back",onClick:this.handleClickBack,role:"button",title:back},closeProps:{"aria-label":close,"data-action":"close",onClick:this.handleClickClose,role:"button",title:close},primaryProps:{"aria-label":primaryText,"data-action":"primary",onClick:this.handleClickPrimary,role:"button",title:primaryText},skipProps:{"aria-label":skip,"data-action":"skip",onClick:this.handleClickSkip,role:"button",title:skip},tooltipProps:{"aria-modal":!0,ref:setTooltipRef,role:"alertdialog"}}});}render(){let{continuous,index,isLastStep,setTooltipRef,size,step}=this.props,{beaconComponent,tooltipComponent,...cleanStep}=step,component;if(tooltipComponent){let renderProps={...this.getElementsProps(),continuous,index,isLastStep,size,step:cleanStep,setTooltipRef};component=React2.createElement(tooltipComponent,{...renderProps});}else component=React2.createElement(Container_default,{...this.getElementsProps(),continuous,index,isLastStep,size,step});return component}},JoyrideStep=class extends React2.Component{constructor(){super(...arguments),__publicField(this,"scope",null),__publicField(this,"tooltip",null),__publicField(this,"handleClickHoverBeacon",event=>{let{step,store}=this.props;event.type==="mouseenter"&&step.event!=="hover"||store.update({lifecycle:LIFECYCLE.TOOLTIP});}),__publicField(this,"setTooltipRef",element=>{this.tooltip=element;}),__publicField(this,"setPopper",(popper,type)=>{var _a;let{action,lifecycle,step,store}=this.props;type==="wrapper"?store.setPopper("beacon",popper):store.setPopper("tooltip",popper),store.getPopper("beacon")&&store.getPopper("tooltip")&&lifecycle===LIFECYCLE.INIT&&store.update({action,lifecycle:LIFECYCLE.READY}),(_a=step.floaterProps)!=null&&_a.getPopper&&step.floaterProps.getPopper(popper,type);}),__publicField(this,"renderTooltip",renderProps=>{let{continuous,helpers,index,size,step}=this.props;return React2.createElement(JoyrideTooltip,{continuous,helpers,index,isLastStep:index+1===size,setTooltipRef:this.setTooltipRef,size,step,...renderProps})});}componentDidMount(){let{debug,index}=this.props;log2({title:`step:${index}`,data:[{key:"props",value:this.props}],debug});}componentDidUpdate(previousProps){var _a;let{action,callback,continuous,controlled,debug,helpers,index,lifecycle,status,step,store}=this.props,{changed,changedFrom}=treeChanges(previousProps,this.props),state=helpers.info(),skipBeacon=continuous&&action!==ACTIONS.CLOSE&&(index>0||action===ACTIONS.PREV),hasStoreChanged=changed("action")||changed("index")||changed("lifecycle")||changed("status"),isInitial=changedFrom("lifecycle",[LIFECYCLE.TOOLTIP,LIFECYCLE.INIT],LIFECYCLE.INIT),isAfterAction=changed("action",[ACTIONS.NEXT,ACTIONS.PREV,ACTIONS.SKIP,ACTIONS.CLOSE]),isControlled=controlled&&index===previousProps.index;if(isAfterAction&&(isInitial||isControlled)&&callback({...state,index:previousProps.index,lifecycle:LIFECYCLE.COMPLETE,step:previousProps.step,type:EVENTS.STEP_AFTER}),step.placement==="center"&&status===STATUS2.RUNNING&&changed("index")&&action!==ACTIONS.START&&lifecycle===LIFECYCLE.INIT&&store.update({lifecycle:LIFECYCLE.READY}),hasStoreChanged){let element=getElement(step.target),elementExists=!!element;elementExists&&isElementVisible(element)?(changedFrom("status",STATUS2.READY,STATUS2.RUNNING)||changedFrom("lifecycle",LIFECYCLE.INIT,LIFECYCLE.READY))&&callback({...state,step,type:EVENTS.STEP_BEFORE}):(console.warn(elementExists?"Target not visible":"Target not mounted",step),callback({...state,type:EVENTS.TARGET_NOT_FOUND,step}),controlled||store.update({index:index+(action===ACTIONS.PREV?-1:1)}));}changedFrom("lifecycle",LIFECYCLE.INIT,LIFECYCLE.READY)&&store.update({lifecycle:hideBeacon(step)||skipBeacon?LIFECYCLE.TOOLTIP:LIFECYCLE.BEACON}),changed("index")&&log2({title:`step:${lifecycle}`,data:[{key:"props",value:this.props}],debug}),changed("lifecycle",LIFECYCLE.BEACON)&&callback({...state,step,type:EVENTS.BEACON}),changed("lifecycle",LIFECYCLE.TOOLTIP)&&(callback({...state,step,type:EVENTS.TOOLTIP}),this.tooltip&&(this.scope=new Scope(this.tooltip,{selector:"[data-action=primary]"}),this.scope.setFocus())),changedFrom("lifecycle",[LIFECYCLE.TOOLTIP,LIFECYCLE.INIT],LIFECYCLE.INIT)&&((_a=this.scope)==null||_a.removeScope(),store.cleanupPoppers());}componentWillUnmount(){var _a;(_a=this.scope)==null||_a.removeScope();}get open(){let{lifecycle,step}=this.props;return hideBeacon(step)||lifecycle===LIFECYCLE.TOOLTIP}render(){let{continuous,debug,index,nonce,shouldScroll:shouldScroll2,size,step}=this.props,target=getElement(step.target);return !validateStep(step)||!src_default.domElement(target)?null:React2.createElement("div",{key:`JoyrideStep-${index}`,className:"react-joyride__step"},React2.createElement(ReactFloater,{...step.floaterProps,component:this.renderTooltip,debug,getPopper:this.setPopper,id:`react-joyride-step-${index}`,open:this.open,placement:step.placement,target:step.target},React2.createElement(JoyrideBeacon,{beaconComponent:step.beaconComponent,continuous,index,isLastStep:index+1===size,locale:step.locale,nonce,onClickOrHover:this.handleClickHoverBeacon,shouldFocus:shouldScroll2,size,step,styles:step.styles})))}},Joyride=class extends React2.Component{constructor(props){super(props),__publicField(this,"helpers"),__publicField(this,"store"),__publicField(this,"callback",data=>{let{callback}=this.props;src_default.function(callback)&&callback(data);}),__publicField(this,"handleKeyboard",event=>{let{index,lifecycle}=this.state,{steps}=this.props,step=steps[index];lifecycle===LIFECYCLE.TOOLTIP&&event.code==="Escape"&&step&&!step.disableCloseOnEsc&&this.store.close("keyboard");}),__publicField(this,"handleClickOverlay",()=>{let{index}=this.state,{steps}=this.props;getMergedStep(this.props,steps[index]).disableOverlayClose||this.helpers.close("overlay");}),__publicField(this,"syncState",state=>{this.setState(state);});let{debug,getHelpers,run,stepIndex}=props;this.store=createStore({...props,controlled:run&&src_default.number(stepIndex)}),this.helpers=this.store.getHelpers();let{addListener}=this.store;log2({title:"init",data:[{key:"props",value:this.props},{key:"state",value:this.state}],debug}),addListener(this.syncState),getHelpers&&getHelpers(this.helpers),this.state=this.store.getState();}componentDidMount(){if(!canUseDOM2())return;let{debug,disableCloseOnEsc,run,steps}=this.props,{start}=this.store;validateSteps(steps,debug)&&run&&start(),disableCloseOnEsc||document.body.addEventListener("keydown",this.handleKeyboard,{passive:!0});}componentDidUpdate(previousProps,previousState){if(!canUseDOM2())return;let{action,controlled,index,lifecycle,status}=this.state,{debug,run,stepIndex,steps}=this.props,{stepIndex:previousStepIndex,steps:previousSteps}=previousProps,{reset,setSteps,start,stop,update:update2}=this.store,{changed:changedProps}=treeChanges(previousProps,this.props),{changed,changedFrom}=treeChanges(previousState,this.state),step=getMergedStep(this.props,steps[index]),stepsChanged=!equal(previousSteps,steps),stepIndexChanged=src_default.number(stepIndex)&&changedProps("stepIndex"),target=getElement(step.target);if(stepsChanged&&(validateSteps(steps,debug)?setSteps(steps):console.warn("Steps are not valid",steps)),changedProps("run")&&(run?start(stepIndex):stop()),stepIndexChanged){let nextAction=src_default.number(previousStepIndex)&&previousStepIndex<stepIndex?ACTIONS.NEXT:ACTIONS.PREV;action===ACTIONS.STOP&&(nextAction=ACTIONS.START),[STATUS2.FINISHED,STATUS2.SKIPPED].includes(status)||update2({action:action===ACTIONS.CLOSE?ACTIONS.CLOSE:nextAction,index:stepIndex,lifecycle:LIFECYCLE.INIT});}!controlled&&status===STATUS2.RUNNING&&index===0&&!target&&(this.store.update({index:index+1}),this.callback({...this.state,type:EVENTS.TARGET_NOT_FOUND,step}));let callbackData={...this.state,index,step};if(changed("action",[ACTIONS.NEXT,ACTIONS.PREV,ACTIONS.SKIP,ACTIONS.CLOSE])&&changed("status",STATUS2.PAUSED)){let previousStep=getMergedStep(this.props,steps[previousState.index]);this.callback({...callbackData,index:previousState.index,lifecycle:LIFECYCLE.COMPLETE,step:previousStep,type:EVENTS.STEP_AFTER});}if(changed("status",[STATUS2.FINISHED,STATUS2.SKIPPED])){let previousStep=getMergedStep(this.props,steps[previousState.index]);controlled||this.callback({...callbackData,index:previousState.index,lifecycle:LIFECYCLE.COMPLETE,step:previousStep,type:EVENTS.STEP_AFTER}),this.callback({...callbackData,type:EVENTS.TOUR_END,step:previousStep,index:previousState.index}),reset();}else changedFrom("status",[STATUS2.IDLE,STATUS2.READY],STATUS2.RUNNING)?this.callback({...callbackData,type:EVENTS.TOUR_START}):(changed("status")||changed("action",ACTIONS.RESET))&&this.callback({...callbackData,type:EVENTS.TOUR_STATUS});this.scrollToStep(previousState),step.placement==="center"&&status===STATUS2.RUNNING&&lifecycle===LIFECYCLE.INIT&&this.store.update({lifecycle:LIFECYCLE.READY});}componentWillUnmount(){let{disableCloseOnEsc}=this.props;disableCloseOnEsc||document.body.removeEventListener("keydown",this.handleKeyboard);}scrollToStep(previousState){let{index,lifecycle,status}=this.state,{debug,disableScrollParentFix=!1,scrollDuration,scrollOffset=20,scrollToFirstStep=!1,steps}=this.props,step=getMergedStep(this.props,steps[index]),target=getElement(step.target),shouldScrollToStep=shouldScroll({isFirstStep:index===0,lifecycle,previousLifecycle:previousState.lifecycle,scrollToFirstStep,step,target});if(status===STATUS2.RUNNING&&shouldScrollToStep){let hasCustomScroll=hasCustomScrollParent(target,disableScrollParentFix),scrollParent2=getScrollParent2(target,disableScrollParentFix),scrollY=Math.floor(getScrollTo(target,scrollOffset,disableScrollParentFix))||0;log2({title:"scrollToStep",data:[{key:"index",value:index},{key:"lifecycle",value:lifecycle},{key:"status",value:status}],debug});let beaconPopper=this.store.getPopper("beacon"),tooltipPopper=this.store.getPopper("tooltip");if(lifecycle===LIFECYCLE.BEACON&&beaconPopper){let{offsets,placement}=beaconPopper;!["bottom"].includes(placement)&&!hasCustomScroll&&(scrollY=Math.floor(offsets.popper.top-scrollOffset));}else if(lifecycle===LIFECYCLE.TOOLTIP&&tooltipPopper){let{flipped,offsets,placement}=tooltipPopper;["top","right","left"].includes(placement)&&!flipped&&!hasCustomScroll?scrollY=Math.floor(offsets.popper.top-scrollOffset):scrollY-=step.spotlightPadding;}scrollY=scrollY>=0?scrollY:0,status===STATUS2.RUNNING&&scrollTo(scrollY,{element:scrollParent2,duration:scrollDuration}).then(()=>{setTimeout(()=>{var _a;(_a=this.store.getPopper("tooltip"))==null||_a.instance.update();},10);});}}render(){if(!canUseDOM2())return null;let{index,lifecycle,status}=this.state,{continuous=!1,debug=!1,nonce,scrollToFirstStep=!1,steps}=this.props,isRunning=status===STATUS2.RUNNING,content={};if(isRunning&&steps[index]){let step=getMergedStep(this.props,steps[index]);content.step=React2.createElement(JoyrideStep,{...this.state,callback:this.callback,continuous,debug,helpers:this.helpers,nonce,shouldScroll:!step.disableScrolling&&(index!==0||scrollToFirstStep),step,store:this.store}),content.overlay=React2.createElement(JoyridePortal,{id:"react-joyride-portal"},React2.createElement(JoyrideOverlay,{...step,continuous,debug,lifecycle,onClickOverlay:this.handleClickOverlay}));}return React2.createElement("div",{className:"react-joyride"},content.step,content.overlay)}};__publicField(Joyride,"defaultProps",defaultProps);var components_default=Joyride;var StyledButton=styled.button`
  all: unset;
...
`,Button=forwardRef(function({children,onClick,variant="primary",...rest},ref){return React2__default.createElement(StyledButton,{ref,onClick,variant,...rest},children)});var TooltipBody=styled.div`
  padding: 15px;
  border-radius: 5px;
`,Wrapper2=styled.div`
  display: flex;
...
`,Count=styled.span`
  font-size: 13px;
`,Tooltip=({index,size,step,closeProps,primaryProps,tooltipProps})=>(useEffect(()=>{let style=document.createElement("style");return style.id="#sb-onboarding-arrow-style",style.innerHTML=`
